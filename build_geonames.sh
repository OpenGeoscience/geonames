...
createlang -U $DBUSER plpgsql ${DBNAME} || true
psql -U $DBUSER -e -d ${DBNAME} -f ${POSTGISPATH}/postgis.sql
psql -U $DBUSER -e -d ${DBNAME} -f ${POSTGISPATH}/postgis_comments.sql
psql -U $DBUSER -e -d ${DBNAME} -f ${POSTGISPATH}/spatial_ref_sys.sql
psql -U $DBUSER -e -d ${DBNAME} -f ${POSTGISPATH}/rtpostgis.sql
psql -U $DBUSER -e -d ${DBNAME} -f ${POSTGISPATH}/raster_comments.sql
psql -U $DBUSER -e -d ${DBNAME} -f ${POSTGISPATH}/topology.sql
psql -U $DBUSER -e -d ${DBNAME} -f ${POSTGISPATH}/topology_comments.sql
